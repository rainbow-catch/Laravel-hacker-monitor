    ...
    <section role="main" class="content-body">
        ...
        <section class="panel">
            <div class="panel-body">
                <div class="pl-sm">
                    <form class="col-md-6 mr-auto col-md-offset-3" id="license-form" target="_blank" method="get" action="/license/generate">
                     <h1 style="color:#2B7EF8"; class="text-center  "><b>License </b><text style="font-size: 20px" class="ml-md"></text> </h1>
                        ...
                        <div class="row mt-md">
                           ...
                           <!-- <label class="col-md-4">Expiration date:</label>
                            ...
                            <div class="col-md-8">
                                <input class="form-control" placeholder="Example: Main.exe" name="client_name"required/>
                            </div>
                        </div>

                        <div class="row mt-md">
                            <label class="col-md-4">Check Memory<BR>
                            <H12><p style="color:#2B7EF8";><b>Only for season 6 or downgrade versions.</b></p></H12></label>
                        ...
                        <div class="row mt-md">
                            ...
                            <H12><p style="color:#2B7EF8";><b>Enable forcing of main.</b></p></H12></label>
                            <div class="col-md-8 switch switch-sm switch-primary">
                                <input type="checkbox" name="force_launcher" data-plugin-ios-switch checked="checked" />
                            </div>
                        </div>
                        ...
                        <div class="row mt-md">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" placeholder="Example: 0xFFFFFFF" name="launcher_crc" required/>
                            </div>
                        </div>

                        <div class="row mt-md">
                            <label class="col-md-4">Macros system<BR>
                            <H12><p style="color:#2B7EF8";><b>Check programs with Auto potions etc.</b></p></H12></label>
                            <div class="col-md-8 switch switch-sm switch-primary">
                        ...
                        <div class="row mt-md">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="max_instances" type="number" min="1" max="40" required value="1"/>
